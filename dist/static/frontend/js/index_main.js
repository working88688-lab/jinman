  ...
  function create_swiper_list() {
    if (utils.isMobile) {
      $('.swiper-list').each(function () {
        const container_type = "dx-".concat($(this).data('type'), "-list");
        ...
        for (let i = 0; i < grid_num; i++) {
          const $ul = $("<div class=\"swiper-slide\"><div class=\"".concat(container_type, " gap-2.5 md:gap-4\"></div></div>"));
          ...
          $ul.find(".".concat(container_type)).append($(gird_html));
