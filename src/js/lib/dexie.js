;(function (e, t) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    : 'function' == typeof define && define.amd
      ? define(t)
      : ((e = 'undefined' != typeof globalThis ? globalThis : e || self).Dexie = t())
})(this, function () {
  'use strict'
  var s = function (e, t) {
    return (s =
  ...
  function r(t, n) {
    'function' == typeof n && (n = n(c(t))),
      ('undefined' == typeof Reflect ? _ : Reflect.ownKeys)(n).forEach(function (e) {
        l(t, e, n[e])
      })
  }
  ...
  function S(e) {
    ...
    e = (function e(t) {
      ...
      if (x(t)) {
        ...
        var o,
          a = c(t)
        for (o in ((n = a === Object.prototype ? {} : Object.create(a)), K.set(t, n), t)) m(t, o) && (n[o] = e(t[o]))
      }
      return n
    })(e)
    return (K = null), e
        ...
        ;(this.name = r),
          e
            ? 'string' == typeof e
              ...
              : 'object' == typeof e && ((this.message = ''.concat(e.name, ' ').concat(e.message)), (this.inner = e))
  ...
  var le = function (e, t) {
    ...
    pe = [],
    ye = X,
    ve = { id: 'global', global: !0, ref: 0, unhandleds: [], onunhandled: G, pgp: !1, env: {}, finalize: G },
    me = ve,
    be = [],
    ge = 0,
    we = []
  function _e(e) {
    ...
    if ('function' != typeof e) {
      ...
      return (
        (this._state = arguments[1]), (this._value = arguments[2]), void (!1 === this._state && Oe(this, this._value))
      )
    }
    ;(this._state = null),
      (this._value = null),
  ...
  var ft =
    ((ht.prototype._trans = function (e, r, t) {
      var n = this._tx || me.trans,
        ...
        o =
          ...
          console.createTask &&
          console.createTask('Dexie: '.concat('readonly' === e ? 'read' : 'write', ' ').concat(this.name))
      function a(e, t, n) {
            ...
            : (function t(n, r, i, o) {
                if (n.idbdb && (n._state.openComplete || me.letThrough || n._vip)) {
                  ...
                  try {
                    ...
                    return e.name === V.InvalidState && n.isOpen() && 0 < --n._state.PR1398_maxLoop
    ...
    (ht.prototype.where = function (o) {
      ...
      !e &&
        ie &&
        console.warn(
          'The query '.concat(JSON.stringify(o), ' on ').concat(this.name, ' would benefit from a ') +
      ...
      var i = n.reduce(
        ...
        t = i[0],
        i = i[1]
      return t ? this.where(t.name).equals(o[t.keyPath]).filter(i) : e ? this.filter(i) : this.where(n).equals('')
    }),
    ...
    (ht.prototype.update = function (e, t) {
      ...
      return void 0 === e
        ? Xe(new Y.InvalidArgument('Given object does not contain its primary key'))
      ...
      return this._trans('readwrite', function (e) {
        ...
        return o.core.mutate({ trans: e, type: 'add', keys: a, values: t, wantResults: u }).then(function (e) {
          var t = e.numFailures,
            ...
            e = e.failures
          if (0 === t) return u ? n : r
          throw new z(''.concat(o.name, '.bulkAdd(): ').concat(t, ' of ').concat(i, ' operations failed'), e)
        })
      })
    }),
      ...
      return this._trans('readwrite', function (e) {
        ...
        return o.core.mutate({ trans: e, type: 'put', keys: a, values: t, wantResults: u }).then(function (e) {
          var t = e.numFailures,
            ...
            e = e.failures
          if (0 === t) return u ? n : r
          throw new z(''.concat(o.name, '.bulkPut(): ').concat(t, ' of ').concat(i, ' operations failed'), e)
        })
      })
    }),
    (ht.prototype.bulkUpdate = function (t) {
      var h = this,
        ...
        d = []
      return this._trans('readwrite', function (e) {
        return n.getMany({ trans: e, keys: r, cache: 'clone' }).then(function (c) {
          var l = [],
            f = []
          ...
          var s = l.length
          return n
            .mutate({ trans: e, type: 'put', keys: l, values: f, updates: { keys: r, changeSpecs: i } })
            .then(function (e) {
              var t = e.numFailures,
                n = e.failures
              if (0 === t) return s
              ...
              throw new z(''.concat(h.name, '.bulkUpdate(): ').concat(t, ' of ').concat(s, ' operations failed'), n)
            })
        })
      })
    }),
    (ht.prototype.bulkDelete = function (t) {
      ...
      return this._trans('readwrite', function (e) {
        ...
        var t = e.numFailures,
          ...
          e = e.failures
        if (0 === t) return n
        throw new z(''.concat(r.name, '.bulkDelete(): ').concat(t, ' of ').concat(i, ' operations failed'), e)
      })
    }),
    ht)
  function ht() {}
    ...
    (Pt.prototype.count = function (e) {
      ...
      return this._read(function (e) {
        var t = i._ctx,
          n = t.table.core
        if (yt(t, !0))
          return n.count({ trans: e, query: { index: bt(t, n.schema), range: t.range } }).then(function (e) {
        ...
        return n
          ...
          .then(function (l) {
            function f(s) {
              ...
              return v.getMany({ trans: d, keys: l.slice(s, s + c), cache: 'immutable' }).then(function (e) {
                for (var n = [], t = [], r = m ? [] : null, i = [], o = 0; o < c; ++o) {
                  var a = e[o],
                ...
                return Promise.resolve(
                  ...
                  .then(function () {
                    return (
                      (0 < i.length || (h && w === Et)) &&
                      v
                        .mutate({ trans: d, type: 'delete', keys: i, criteria: h, isAdditionalChunk: 0 < s })
                        .then(function (e) {
                          return y(i.length, e)
                        })
                    )
            ...
            var h = yt(r) &&
              r.limit === 1 / 0 &&
              ('function' != typeof w || w === Et) && { index: r.index, range: r.range }
        ...
        mutate: function (e) {
          ...
          return new Promise(function (t, e) {
            ...
            var s = [],
              ...
              l = 0
            if ('deleteRange' === v) {
              if (4 === g.type) return t({ numFailures: l, failures: c, results: [], lastResult: void 0 })
              ...
              h
                ...
                : ((r = 0),
                  ...
                  (i.onsuccess = function (e) {
                    var t = i.result
                    return t
                      ? (o.push(a ? t.value : t.primaryKey), ++r === u ? n({ result: o }) : void t.continue())
                      : n({ result: o })
                  }),
                  (i.onerror = Bt(e)))
            })
                    ...
                    indexes: Qt(t.indexNames)
                      ...
                      .map(function (e) {
                        var t = e.name,
                          ...
                          r = e.multiEntry,
                          e = e.keyPath,
                          r = { name: t, compound: x(e), keyPath: e, unique: n, multiEntry: r, extractKey: $t(e) }
                        return (i[Xt(e)] = r)
                      }),
                        ...
                        t.push(function () {
                          ...
                          t.push(function (e) {
                            ...
                            ;(t = r),
                              ...
                              tn(s, [s.Transaction.prototype]),
                              en(s, [s.Transaction.prototype], s._storeNames, s._dbSchema),
                              (l.schema = s._dbSchema)
                          }),
                          t.push(function (e) {
                            s.idbdb.objectStoreNames.contains('$meta') &&
                              (Math.ceil(s.idbdb.version / 10) === u._cfg.version
                                ? (s.idbdb.deleteObjectStore('$meta'),
                                  delete s._dbSchema.$meta,
                                  (s._storeNames = s._storeNames.filter(function (e) {
                                    return '$meta' !== e
                                  })))
  ...
  function sn(t, n) {
    _(t).forEach(function (e) {
      n.db.objectStoreNames.contains(e) ||
        (ie && console.debug('Dexie: Creating missing table', e), un(n, e, t[e].primKey, t[e].indexes))
    })
  }
  function cn(e, t) {
      ...
      b(t.objectStoreNames, 0).forEach(function (e) {
        for (
          var t = u.objectStore(e),
            n = zt(Vt((a = t.keyPath)), a || '', !0, !1, !!t.autoIncrement, a && 'string' != typeof a, !0),
            r = [],
            i = 0;
  ...
  function hn(e) {
    return e.split(',').map(function (e, t) {
      ...
      return zt(n, r || null, /\&/.test(e), /\*/.test(e), /\+\+/.test(e), x(r), 0 === t)
    })
  }
  var dn =
    ...
    (pn.prototype.stores = function (e) {
      ...
      return (
        ...
        en(t, [t._allTables, t, t.Transaction.prototype, this._cfg.tables], _(r), r),
        (t._storeNames = _(r)),
        this
      )
    }),
  ...
  function yn(e, t) {
    ...
    return (
      n ||
        (n = e._dbNamesDB = new er(tt, { addons: [], indexedDB: e, IDBKeyRange: t }))
          .version(1)
          .stores({ dbnames: 'name' }),
      n.table('dbnames')
    )
  ...
  function wn(e, t, n) {
    ...
    if (!isNaN(r)) {
      ...
      var i = e.l,
        r = e.r
      if (st(n, e.from) < 0) return i ? wn(i, t, n) : (e.l = { from: t, to: n, d: 1, l: null, r: null }), On(e)
      if (0 < st(t, e.to)) return r ? wn(r, t, n) : (e.r = { from: t, to: n, d: 1, l: null, r: null }), On(e)
      st(t, e.from) < 0 && ((e.from = t), (e.l = null), (e.d = r ? r.d + 1 : 1)),
        0 < st(n, e.to) && ((e.to = n), (e.r = null), (e.d = e.l ? e.l.d + 1 : 1))
      n = !e.r
    ...
    return {
      next: function (e) {
        for (var t = 0 < arguments.length; n; )
          switch (n.s) {
            case 0:
              if (((n.s = 1), t)) for (; n.n.l && st(e, n.n.from) < 0; ) n = { up: n, n: n.n.l, s: 1 }
              else for (; n.n.l; ) n = { up: n, n: n.n.l, s: 1 }
            case 1:
              if (((n.s = 2), !t || st(e, n.n.to) <= 0)) return { value: n.n, done: !1 }
            case 2:
              if (n.n.r) {
        ...
        t[e]
          ...
          : (t[e] = (function e(t) {
              var n,
                ...
                i = {}
              for (n in t)
                m(t, n) && ((r = t[n]), (i[n] = !r || 'object' != typeof r || E.has(r.constructor) ? r : e(r)))
              return i
            })(n[e]))
      }),
      t
  ...
  function Dn(e, t) {
    void 0 === t && (t = !1)
    var n = new Set()
    if (e.all) for (var r = 0, i = Object.values(Sn); r < i.length; r++) Tn((a = i[r]), e, n, t)
    else
      for (var o in e) {
        var a,
          u = /^idb\:\/\/(.*)\/(.*)\//.exec(o)
        u && ((o = u[1]), (u = u[2]), (a = Sn['idb://'.concat(o, '/').concat(u)]) && Tn(a, e, n, t))
      }
              ...
              function o(n) {
                return Object.create(n, {
                  continue: {
                    value: function (e) {
                      null != e
                        ? n.continue(Bn(e, t.reverse ? f.MAX_KEY : f.MIN_KEY, r))
                        : t.unique
                          ? n.continue(n.key.slice(0, i).concat(t.reverse ? f.MIN_KEY : f.MAX_KEY, r))
                          : n.continue()
                    }
                  },
                  continuePrimaryKey: {
          ...
          return w(w({}, y), {
            mutate: function (e) {
                  ...
                  return t._promise(
                    ...
                    function () {
                      return (function n(r, i, o) {
                        return y
                          .query({ trans: r, values: !1, query: { index: v, range: i }, limit: o })
                          .then(function (e) {
                            var t = e.result
                            return a({ type: 'delete', keys: t, trans: r }).then(function (e) {
                              return 0 < e.numFailures
                                ...
                                : t.length < o
                                  ...
                                  : n(r, w(w({}, i), { lower: t[t.length - 1], lowerOpen: !0 }), o)
                            })
                          })
                      })(e.trans, e.range, 1e4)
                    },
              ...
              function a(c) {
                ...
                return (
                  'delete' !== (c = 'add' === c.type || 'put' === c.type ? w(w({}, c), { keys: f }) : w({}, c)).type &&
                  ...
                  ('add' === (t = c).type
                        ...
                        'delete' === c.type
                          ...
                          : 'add' === c.type || void 0 === o
                            ? ((n = d.fire.call(a, e, c.values[t], l)),
                              null == e &&
                                null != n &&
                                ((c.keys[t] = e = n), v.outbound || P(c.values[t], v.keyPath, e)))
                            : ((n = Fn(o, c.values[t])),
                    ...
                    return y
                      ...
                      .then(function (e) {
                        for (
                          var t = e.failures, n = e.results, r = e.numFailures, e = e.lastResult, i = 0;
                          i < f.length;
                          ++i
                        ) {
                          var o = (n || f)[i],
                          ...
                          null == o
                            ...
                            : a.onsuccess && a.onsuccess('put' === c.type && u[i] ? c.values[i] : o)
                        }
            ...
            getMany: function (t) {
              ...
              return e
                ...
                : n.getMany(t).then(function (e) {
                    return (t.trans._cache = { keys: t.keys, values: 'clone' === t.cache ? S(e) : e }), e
                  })
            },
            mutate: function (e) {
        ...
        table: function (d) {
          var p = r.table(d),
            ...
            t = w(w({}, p), {
              mutate: function (i) {
                function o(e) {
                  return (e = 'idb://'.concat(b, '/').concat(d, '/').concat(e)), n[e] || (n[e] = new gn())
                }
                var e,
                  a,
                  u,
                ...
                return (
                  x(f)
                    ? (r.addKeys(f),
                      (l = 'delete' === c || f.length === h.length ? Ln(f, l) : null) || s.addKeys(f),
                      (l || h) &&
                        ((e = o),
                        (a = l),
                        (u = h),
              ...
              t[s] = function (i) {
                ...
                if (t) {
                  ...
                  if ((('query' === s && t.isPrimaryKey && !i.values ? a : r(t.name || '')).add(e), !t.isPrimaryKey)) {
                    if ('count' !== s) {
                      var u = 'query' === s && l && i.values && p.query(w(w({}, i), { values: !1 }))
  ...
  function $n(e, t) {
    return (
      (n = e),
      (void 0 === (r = t).lower || (r.lowerOpen ? 0 < st(n, r.lower) : 0 <= st(n, r.lower))) &&
        ((e = e), void 0 === (t = t).upper || (t.upperOpen ? st(e, t.upper) < 0 : st(e, t.upper) <= 0))
    )
    var n, r
  }
  function Qn(e, u, t, n, r, s) {
    ...
    return t === e
      ...
      : (t.sort(function (e, t) {
        ...
        u.limit &&
          u.limit < 1 / 0 &&
          (t.length > u.limit ? (t.length = u.limit) : e.length === u.limit && t.length < u.limit && (r.dirty = !0)),
        s ? Object.freeze(t) : t)
  }
  function Gn(e, t) {
    return (
      ...
      return w(w({}, k), {
                                ...
                                (b && !p.dirty
                                  ? ((y = Object.isFrozen(p.res)),
                                    ...
                                    p.dirty
                                      ...
                                      : y !== p.res && ((p.res = y), (p.promise = _e.resolve({ result: y }))))
                                  : (p.dirty && T(d, p),
                                    p.subscribers.forEach(function (e) {
                                      return t.add(e)
                                    })))
        ...
        table: function (c) {
          ...
          return w(w({}, l), {
            mutate: function (t) {
              var e = me.trans
              if (i.outbound || 'disabled' === e.db._options.cache || e.explicit) return l.mutate(t)
              ...
              return (
                ...
                !(
                  ...
                  ? (n.optimisticOps.push(t),
                    ...
                    e.catch(function () {
                      T(n.optimisticOps, t), t.mutatedParts && Cn(t.mutatedParts)
                    }))
                  : e.then(function (r) {
                      var e = Yn(
                        0,
                        w(w({}, t), {
                          values: t.values.map(function (e, t) {
                            var n,
                              e = null !== (n = i.keyPath) && void 0 !== n && n.includes('.') ? S(e) : w({}, e)
                  ...
                  switch (n) {
                    case 'query':
                      var a = o.find(function (e) {
                        return (
                          e.req.limit === r.limit && e.req.values === r.values && Gn(e.req.query.range, r.query.range)
                        )
                      })
                      return a
                        ? [a, !0, i, o]
              ...
              return (
                a && e
                  ...
                  : ((e = l
                    ...
                    (a = { obsSet: t.obsSet, promise: e, subscribers: new Set(), type: 'query', req: t, dirty: !1 }),
                    s
                      ? s.push(a)
                      : ((s = [a]),
                        ((u =
                ...
                a.promise.then(function (e) {
                  return { result: Qn(e.result, t, null == u ? void 0 : u.optimisticOps, l, a, i) }
                })
              )
            }
          })
  ...
  var er =
    ((tr.prototype.version = function (t) {
      if (isNaN(t) || t < 0.1) throw new Y.Type('Given version is not a positive number')
    ...
    (tr.prototype._transaction = function (e, t, n) {
      ...
      var s = function i(o, a, u, s, c) {
        return _e.resolve().then(function () {
          ...
          if (((t.explicit = !0), (e = { trans: t, transless: e }), s)) t.idbtrans = s.idbtrans
          else
            try {
              t.create(), (t.idbtrans._explicit = !0), (o._state.PR1398_maxLoop = 3)
            } catch (e) {
              return e.name === V.InvalidState && o.isOpen() && 0 < --o._state.PR1398_maxLoop
                ? (console.warn('Dexie: Need to reopen db'),
            ...
            (e = _e.follow(function () {
              ...
              ;(n = c.call(t, t)) &&
                (r
                  ...
                  : 'function' == typeof n.next && 'function' == typeof n.throw && (n = In(n)))
            }, e)),
            (n && 'function' == typeof n.then
              ? _e.resolve(n).then(function (e) {
                  return t.active
                    ? e
                    : Xe(new Y.PrematureCommit('Transaction committed too early. See http://bit.ly/2kdckMn'))
                })
              : e.then(function () {
                  return n
                })
  ...
  function tr(e, t) {
    ...
    ;(this._options = t =
      w({ addons: tr.addons, autoOpen: !0, indexedDB: n.indexedDB, IDBKeyRange: n.IDBKeyRange, cache: 'cloned' }, t)),
    ...
    ;(c.dbReadyPromise = new _e(function (e) {
      ...
      (this._state = c),
      (this.name = e),
      (this.on = dt(this, 'populate', 'blocked', 'versionchange', 'close', { ready: [re, G] })),
        ...
        pt(ft.prototype, function (e, t, n) {
          ;(this.db = r),
            ...
            (this.hook = r._allTables[e]
              ? r._allTables[e].hook
              : dt(null, { creating: [Z, G], reading: [H, X], updating: [te, G], deleting: [ee, G] }))
        }))),
      (this.Transaction =
        ((u = this),
      ...
      (this.Version =
        ...
        pt(dn.prototype, function (e) {
          ;(this.db = i),
            (this._cfg = { version: e, storesSource: null, dbschema: {}, tables: {}, contentUpgrade: null })
        }))),
      (this.WhereClause =
        ((s = this),
      ...
      this.on('blocked', function (e) {
        !e.newVersion || e.newVersion < e.oldVersion
          ...
          : console.warn(
              "Upgrade '".concat(o.name, "' blocked by other connection holding version ").concat(e.oldVersion / 10)
            )
      }),
        ...
        var f = function (e) {
          ...
          t = function () {
            ...
            !a &&
              ...
              })((n = { subscr: t, signal: o.signal, requery: l, querier: h, trans: null }))),
              Promise.resolve(e).then(
                ...
                function (e) {
                  ;(p = !1),
                    ['DatabaseClosedError', 'AbortError'].includes(null == e ? void 0 : e.name) ||
                      a ||
                      Ge(function () {
                        a || (r.error && r.error(e))
                      })
  ...
  r(
    ...
    'undefined' != typeof dispatchEvent &&
      ...
      (Nt(Ft, function (e) {
        cr || ((e = new CustomEvent(Mt, { detail: e })), (cr = !0), dispatchEvent(e), (cr = !1))
      }),
  ...
  return (
    ...
    'undefined' != typeof addEventListener &&
      ...
      addEventListener('pageshow', function (e) {
        !er.disableBfCache &&
          e.persisted &&
          (ie && console.debug('Dexie: handling persisted pageshow'), lr(), ur({ all: new gn(-1 / 0, [[]]) }))
      })),
    (_e.rejectionMapper = function (e, t) {
      return !e || e instanceof N || e instanceof TypeError || e instanceof SyntaxError || !e.name || !$[e.name]
        ? e
